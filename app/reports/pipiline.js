...
var pipeline = [{
...

    {
        $facet: {
            "dailydata": [{
                ...
                {
                    $project: {
                        "hospital": { "$setUnion": ["$hospitalrequest", "$hospitalvil"] },
                ...
                {
                    $project: {
                        "hospital": { "$setUnion": ["$hospital", "$hospitalconfirmation"] },
        ...
        
                {
                    $group: {
                        ...
                        hospitalrequest: { $sum: "$hospital.hospitalrequest" },
                        hospitalvil: { $sum: "$hospital.hospitalvil" },
                        hospitalconfirmation: { $sum: "$hospital.hospitalconfirmation" },
    ...
    // { $project: { activity: { $setUnion: ['$dailydata', '$monthlydata', '$annualdata'] } } },
        { $project: { activity: { $setUnion: ['$dailydata'] } } },
    { $unwind: '$activity' },
